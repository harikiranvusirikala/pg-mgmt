...
public class AllocationStatsService {
	 ...
	 * @param allocationStatsRepository repository for persisting allocation
	 *                                  snapshots
	 */
	...
	/**
	 * Computes the allocation snapshot for the supplied date and persists it,
	 * updating the existing record when one already exists.
	 *
